                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <h2 class="sc_title sc_title_regular sc_align_center margin_top_null margin_bottom_small">Liên Hệ</h2>
                                                <div class="sc_section margin_bottom_large aligncenter">
                                                    <div class="sc_section_inner">
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p>
                                                                         Giờ mở cửa: 8.00-22.00 Thứ Hai - Chủ Nhật
                                                                    <br /> Hãy gọi cho đội ngũ đặt chỗ của chúng tôi theo số 086 6011 730 để biết thêm thông tin.
                                                                </p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="sc_section margin_right_null margin_left_null aligncenter">
                                                    <div class="sc_section_inner">
                                                        <h5 class="sc_title sc_title_regular margin_top_small">Theo dõi chúng tôi</h5>
                                                                ...
                                                                <form id="sc_form_132_form" data-formtype="form_1" method="post" action="includes/sendmail.php">
                                                                    <div class="sc_form_info">
                                                                        <div class="sc_form_item sc_form_field label_over">
                                                                            ...
                                                                            <input id="sc_form_username" type="text" name="username" placeholder="Tên *">
                                                                        </div>
                                                                        <div class="sc_form_item sc_form_field label_over">
                                                                        ...
                                                                        <div class="sc_form_item sc_form_field label_over">
                                                                            <label class="required" for="sc_form_subj">Chủ thể</label>
                                                                            <input id="sc_form_subj" type="text" name="subject" placeholder="Subject">
                                                                        </div>
                                                                    </div>
                                                                    <div class="sc_form_item sc_form_message label_over">
                                                                        <label class="required" for="sc_form_message">Tin nhắn</label>
                                                                        <textarea id="sc_form_message" name="message" placeholder="Tin nhắn"></textarea>
                                                                    </div>
